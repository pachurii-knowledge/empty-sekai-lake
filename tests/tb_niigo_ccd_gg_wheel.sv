...
;
    ...
    initial begin
        ...
        $display("  [info] C1 deferrals: %0d (deferral proven on ccd-gg-test where RESP_DLY forces the window)", defer_cnt-c1d);
        ...
        $display("  [info] C7 deferrals: %0d", defer_cnt-c7d);
        ...
        $display("  [info] C3 deferrals: %0d", defer_cnt-c3d);
