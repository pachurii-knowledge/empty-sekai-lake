...
(
    ...
    input wire logic                  axi_awvalid, axi_awready,
    input wire logic [AXI_ADDR_W-1:0] axi_awaddr,
    input wire logic [AXI_ID_W-1:0]   axi_awid,
    input wire logic [7:0]            axi_awlen,
    input wire logic [2:0]            axi_awsize,
    input wire logic [1:0]            axi_awburst,
    input wire logic                  axi_wvalid, axi_wready,
    input wire logic [AXI_DATA_W-1:0] axi_wdata,
    input wire logic                  axi_wlast,
    input wire logic                  axi_bvalid, axi_bready,
    input wire logic [AXI_ID_W-1:0]   axi_bid,
    input wire logic                  axi_arvalid, axi_arready,
    input wire logic [AXI_ADDR_W-1:0] axi_araddr,
    input wire logic [AXI_ID_W-1:0]   axi_arid,
    input wire logic [7:0]            axi_arlen,
    input wire logic [2:0]            axi_arsize,
    input wire logic [1:0]            axi_arburst,
    input wire logic                  axi_rvalid, axi_rready,
